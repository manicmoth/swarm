...
class Segmenter():
    def __init__(self) -> None:
        ...
        self.cfg.merge_from_file(model_zoo.get_config_file("COCO-InstanceSegmentation/mask_rcnn_R_50_FPN_3x.yaml")) #"COCO-PanopticSegmentation/panoptic_fpn_R_50_1x.yaml")
